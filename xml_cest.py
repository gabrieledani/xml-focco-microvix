...
nome_arquivo_xml = os.path.join(os.getcwd(),r'arquivos\LinxCadastraCest.xml')
   ...
   <soapenv:Body>
      <tem:Importar>
			<tem:request>
				...
				<linx:Tabela>
					<linx2:Comando>LinxCadastraCest</linx2:Comando>
					<linx2:Registros>'''
xml_produto.write(head)

nome_arquivo = os.path.join(os.getcwd(),r'arquivos\cest.csv')
#print(nome_arquivo)
						...
						<linx:Registros>
							<linx:Colunas>
								...
								<linx1:CommandParameter>
									...
									<linx1:Value>'''+descricao.upper()+'''</linx1:Value>
								</linx1:CommandParameter>
							</linx:Colunas>
						</linx:Registros>'''
