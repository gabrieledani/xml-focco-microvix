...
nome_arquivo_xml = os.path.join(os.getcwd(),r'arquivos\LinxCadastraSetores.xml')
...
nome_arquivo = os.path.join(os.getcwd(),r'arquivos\setores.csv')
#print(nome_arquivo)
...
with open(nome_arquivo, encoding="mbcs") as csv_file:
	...
	for row in csv_reader:
		codigo, nome_setor = row[0],row[1]

		codigo = clean(codigo)

		nome_setor = clean(nome_setor)
						...
						<linx:Registros>
							<linx:Colunas>
								...
								<linx1:CommandParameter>
									...
									<linx1:Value>'''+nome_setor.upper()+'''</linx1:Value>
								</linx1:CommandParameter>
							</linx:Colunas>
						</linx:Registros>'''
